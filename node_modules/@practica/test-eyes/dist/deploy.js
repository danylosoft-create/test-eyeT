...
import { configureGit, getDefaultGitConfig, fetchBranch, branchExists, checkoutBranch, createOrphanBranch, stageFiles, hasChanges, commit, push, getCurrentBranch } from './git-operations.js';
...
export async function deployDashboard(options = {}) {
    ...
    await copyFile(path.join(tempDir, 'main-test-data.json'), path.join(tempDir, 'site', 'data', 'main-test-data.json'));
